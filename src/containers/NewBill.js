...
export default class NewBill {
  ...
  handleChangeFile = (e) => {
    ...
    // To Do -> Extensions limited
    const limitedExtensions = ["jpg", "jpeg", "png"];
    const fileExtension = fileName.split(".").pop().toLowerCase();

    if (!limitedExtensions.includes(fileExtension)) {
      alert("Extensions non permises");
      //   console.log("Invalid file extension:", fileExtension);
      //   const errorElement = document.createElement("div");
      //   errorElement.textContent =
      //     "Seules les extensions .png, .jpg ou .jpeg sont autorisées";
      //   errorElement.style.color = "red";
      //   fileInput.parentNode.appendChild(errorElement);
      //   file.parentNode.appendChild(errorElement);
    }
    ...
    this.store
      ...
      .then(({ fileUrl, key }) => {
        console.log("API response:", { fileUrl, key });
        console.log(fileUrl);
        this.billId = key;
